...
import onslaught.core.lwjgl.LWJGLTexture;
...
public class TextureLoader {
     ...
     */
    public LWJGLTexture getTexture(String resourceName) throws IOException {
        LWJGLTexture tex = (LWJGLTexture) table.get(resourceName);
     ...
     * @throws IOException Indicates a failure to access the resource
     */
    public LWJGLTexture getTexture(String resourceName,
            int target,
            int dstPixelFormat,
            int minFilter,
        ...
        LWJGLTexture texture = new LWJGLTexture(target, textureID);
     ...
     */
    private ByteBuffer convertImageData(BufferedImage bufferedImage, LWJGLTexture texture) {
        ...
        //g.drawRect(0, 0, texWidth, texHeight);
